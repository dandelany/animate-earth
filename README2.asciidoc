...
```
butterflow -s full,spd=0.5 -r 60 -o outfile.mp4 infile.mp4
```
https://github.com/dthpham/butterflow/wiki/Example-Usage[More example usage is shown on the Butterflow wiki], and additional command parameters can be discovered by running `butterflow -h`.
